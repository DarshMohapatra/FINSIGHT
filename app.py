...
def normalize_columns(df):
    ...
    date_c   = ["DATE","TRANSACTION DATE","TXN DATE","VALUE DATE","POSTING DATE","TRANS DATE","TRAN DATE","BOOK DATE","TXNDATE","VALUEDATE"]
    detail_c = ["TRANSACTION DETAILS","NARRATION","DESCRIPTION","PARTICULARS","REMARKS","TRANSACTION NARRATION","DETAILS","TRAN PARTICULARS","CHEQUENO/NARRATION","TRAN. PARTICULAR","TRANSACTION PARTICULAR"]
